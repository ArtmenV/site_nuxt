    ...
    <div class="details__info">
      <details-block>
        ...
        <div class="body">
          ...
          >
            <nuxt-link
              :to="'challenge-results?id=' + entry.challenge.id"
              class="link"
            >
          ...
          <!-- <info-block
            label="Collection:"
          >
            <span class="link">Challenge Photographs</span>
          </info-block> -->

          <!-- <info-block
            label="Camera:"
          >
            <span class="silent-link">Olympus C-700UZ</span>
          </info-block> -->
          ...
          <!-- <info-block
            label="Galleries:"
          >
            <span class="link">Sports</span>, <span class="link">Macro</span>
          </info-block> -->
